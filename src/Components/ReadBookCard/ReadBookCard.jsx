    ...
    >
      ...
      <div className="lg:w-4/5 w-full ">
        ...
        <div className="flex items-center lg:text-sm text-xs gap-2">
          <h3 className="bg-[#328eff26]  text-[#328EFF] w-fit px-3 py-1 font-normal  rounded-full">
            Category: {book.category}
          </h3>
          <h3 className="bg-[#FFAC3326] text-sm text-[#FFAC33] w-fit px-3 py-1 font-normal rounded-full">
            Rating: {book.rating}
          </h3>
          <Link
            to={`/book/${book.id}`}
